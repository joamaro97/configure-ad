...
<p>
After creating the users, Client-1 can now be signed in as one of the new users created from the PowerShell script. Pick a name and simply sign in to the client with the context of the domain. In my case, it is labtest.com\bare.vil
</p>
<br />
